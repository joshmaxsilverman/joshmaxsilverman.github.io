...
{:.caption}
**Intensity diagram** *the intensity of the mark left a distance $r$ from the tip's center is proportional to fraction of the circle's surface area that drags past the point, e.g. the length of the chord at $r.$ Using the Pythagorean theorem, the chord has length $\ell = 2\sqrt{1 - r^2}.$
