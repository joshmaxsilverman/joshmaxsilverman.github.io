...
$$ \begin{align}
    ...
    g^{ma}g_{a\ell}\frac{d^2 X^a}{d\tau^2} &= g^{ma}\frac{1}{2}\left(\frac{\partial g_{ab}}{\partial X^\ell} - \frac{\partial g_{a\ell}}{\partial X^b} - \frac{\partial g_{b\ell}}{\partial X^a}\right) \frac{dX^a}{d\tau}\frac{dX^b}{d\tau}
    \end{align}
$$
<br>
