...
Since the winning probability for the last team seems to be exactly the $20$th harmonic number divided by 20 (thanks, Rajeev!), and the puzzle pointedly asks only about the last team, there is certain to be a more direct way to it than this, but I have not found it.
