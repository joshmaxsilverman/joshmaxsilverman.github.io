...
Let's inductively show that, for the last of a race of $n$ teams, the winning probability is the $n$th Harmonic Number divided by $n$. This is clearly true for a race of one team. Assume, then, that for some $n-1$, the hypothesis is true:
