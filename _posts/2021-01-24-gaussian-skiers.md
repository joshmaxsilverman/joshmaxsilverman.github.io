...
$$
    \begin{align}
        ...
        &\approx -\frac{1}{\sqrt{2\pi}}e^{-({f_{1}^{\*}}^2 - 2x)/2}\left[\frac{1}{f_1} + \frac{1}{f_1^3}\right] + \frac{1}{\sqrt{2\pi}}e^{-({s_{1}^{\*}}^2 -2\sqrt{2} (x+y))/4}\left[\frac{\sqrt{2}}{f_1+s_1} + \frac{2\sqrt{2}}{(f_1+s_1)^3}\right] \\
