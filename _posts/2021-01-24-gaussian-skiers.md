...
$$
    ...
    &= N N^{-(4-\sqrt{2})} \exp\left(x + y(\sqrt{2}-1) + O(1/\gamma^2)\right)
    \end{align}
$$
...
$$
    \begin{align}
        \varepsilon(f_1,s_1) &\approx \frac{1}{\sqrt{2\pi}}e^{-f_1^2/2}\left(1/f_1 + 1/f_1^3\right) + \frac{1}{\sqrt{2\pi}}e^{-(f_1+s_1)^2/4}\left(\sqrt{2}/(f_1+s_1) + 2\sqrt{2}/(f_1+s_1)^3\right)
    \end{align}
$$
