...
$$ -\frac{1}{\sqrt{2\pi}}\left(e^{x} + e^{x + h/\sqrt{2}}\right)\left(\frac{1}{\gamma} + \frac{1}{\gamma^3}\right) \approx -\frac{1}{\sqrt{2\pi}}\left(e^{x}\left(2 + \frac{d}{\sqrt{2}} + \frac{d^2}{4}\right)\right)\left(\frac{1}{\gamma} + \frac{1}{\gamma^3}\right) $$
