...
$$
    \begin{align}
        ...
        &= \frac{1}{\sqrt{2\pi}}e^{-(\gamma^2 + 2x)/2}\left[\frac{1}{\gamma + x/\gamma} + \frac{1}{(\gamma + x/\gamma)^3}\right] + \frac{1}{\sqrt{2\pi}}e^{-(-2\sqrt{\log N} + (x+y)/\sqrt{2\log N})^2/4}\left[\frac{\sqrt{2}}{f_1+s_1} + \frac{2\sqrt{2}}{(f_1+s_1)^3}\right]
    \end{align}
$$
