...
$$ \displaystyle P \approx \dfrac{\int_0^1\text{d}\theta \int_0^{\pi-\theta}\text{d}\beta \left(\pi-\theta\right)\left(\pi-\beta\right)\left(\theta+\beta\right)}{\int_0^1\text{d}\theta \int_0^{\pi-\theta}\text{d}\beta}. $$
