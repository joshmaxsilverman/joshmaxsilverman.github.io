...
below is a graph comparing $5\times 10^6$-run simulations of the system for various values of $\phi$ for the $20$ person table along with the analytical prediction.
