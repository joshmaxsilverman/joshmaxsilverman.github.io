...
$$ L(10) = \overbrace{\gamma(1\rightarrow 9\vert !11)}^\text{without hitting $11$}\times \overbrace{\gamma(9\rightarrow 11)}^\text{without hitting $10$} + \overbrace{\gamma(1\rightarrow 11)}^\text{without hitting $9$}\times \overbrace{\gamma(11\rightarrow 9)}^\text{without hitting $10$} $$
