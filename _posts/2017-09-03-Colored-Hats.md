...
For a non-computational approach that will scale to larger $N$, we will design a set of sixteen such signals more systematically, as a [Hamming Code](https://en.wikipedia.org/wiki/Hamming_code).  
