...
To get the expectation for the problem as posed, we simply need to multiply by the constant factor $\frac{n}{n-1}$ for every dude's probability in the sum, yielding:
