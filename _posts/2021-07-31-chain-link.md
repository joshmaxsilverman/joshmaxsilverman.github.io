...
We can put this in a more compact form that makes the behavior clearer. If we act on $\mathbf{p}_n$ 
<!-- with $f\mathbf{R}_\phi$ and subtract it from $\mathbf{p}_n,$ we get: -->
