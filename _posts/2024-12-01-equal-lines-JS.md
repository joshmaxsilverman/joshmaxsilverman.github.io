...
The circles overlap at $x = x_b$ so the area of the left segment is $ \frac12\left(\theta r_\ell^2 - x_b y_b\right). $ Putting it together with the same analysis for the right segment, we get the area of the overlap
