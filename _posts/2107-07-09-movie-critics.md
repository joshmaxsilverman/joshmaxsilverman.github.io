...
There is an ambiguity in the statement of the problem. The _static_ interpretation requires us to assign critics to watch fixed sequences of movies in advance. The _dynamic_ interpretation allows for the critics to base their plans on all the critics' evaluative judgments before every viewing. While I doubt it makes a difference, I am not sure of that, and I will operate on the assumption that the static interpretation is intended.
