...
$$
  Z^{21} = 2! p_\text{girl} p_\text{Mary} p_\text{boy}\times P(\text{family of 2})
$$
...
$$
  \begin{align}
    Z^{32} &= 1\times 3! p_\text{Mary} (1-p_\text{Mary}) p_\text{boy}p_\text{girl}^2 \times P(\text{family of 3})\\
    Z^{31} &= 2 \times \dfrac{3!}{2!}p_\text{Mary} p_\text{boy}^2p_\text{girl}\times P(\text{family of 3})
  \end{align}
$$
...
$$
  \begin{align}
    Z^{43} &= 1\times 4! p_\text{Mary}(1-p_\text{Mary})^2 p_\text{boy}p_\text{girl}^3 \times P(\text{family of 4})\\
    Z^{42} &= 2\times \dfrac{4!}{2!}p_\text{Mary}(1-p_\text{Mary}) p_\text{boy}^2p_\text{girl}^2 \times P(\text{family of 4})\\
    Z^{41} &= 3\times \dfrac{4!}{3!}p_\text{Mary} p_\text{boy}^3p_\text{girl}\times P(\text{family of 4})
  \end{align}
$$
