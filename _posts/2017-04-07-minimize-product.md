...
There are $5040$ possible sequences of four cards, and $24$ possible ways to place the cards in any given sequence, and so it might seem that the space of possibilities we have to consider is unsurveyably vast. However, when you have placed the first card and have received your second, there are three places to choose from, and only $56$ sequences of third and fourth cards to consider. So the calculation of the three expectations will be straightforward, if tedious, amounting to doing $168$ two-by-two-digit multiplications and averaging three sets of $56$ numbers. Choose a location with the highest of these expectations, and then proceed the same way with the third card---when you're down to only two expectations based on only $7$ possibilities. You're done!
