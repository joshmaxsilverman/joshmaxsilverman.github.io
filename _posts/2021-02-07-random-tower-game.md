...
$$\overbrace{\frac{1}{2}\times T(1\rightarrow 3)}^{v(x)-v(y)} &= \overbrace{\frac{1}{2}\times\frac{1}{2}\left[\left(\frac{5}{3}\right)^n - 1\right]}^{I_{xy}}\overbrace{\times\left(\left(3^n - 3\right)\times 3 + 3\times 2\right)}^\text{R_{xy}}$$
