...
- And it is the same as the positive first element of the [eigenvector](https://en.wikipedia.org/wiki/Eigenvalues_and_eigenvectors) of the matrix [$(x\ y; 1\ 1)$](https://twitter.com/jjaredsimpson/status/899708484299763712).
