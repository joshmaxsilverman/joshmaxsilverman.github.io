...
Plugging in $p = \frac12$ for the coin, the eigenvalues are $0,$ $\lambda_1 = \frac12\left(\frac12-\frac{\sqrt{5}}{2}\right),$ and $\lambda_1 = \frac12\left(\frac12+\frac{\sqrt{5}}{2}\right).$ Taking the products, we get 

$$ 
   \begin{align}
      P_3(t) &= \frac{\left(\frac{1}{2}+\frac{\sqrt{5}}{2}\right) \lambda_1^t+\left(\frac{\sqrt{5}}{2}-\frac{1}{2}\right) \lambda_2^t}{\sqrt{5}} \\
      &= -\left(\frac{\sqrt{5}}{2}-\frac12}\right)^{t-1} + \left(\frac{\sqrt{5}}{2}+\frac12}\right)^{t-1}
   \end{align}
$$
