...
$$ \left(\begin{array}p_1(t) \\ p_2(t) \\ p_3(t)\end{array}\right) = \left(\begin{array}{ccc} (1-p) & (1-p) & 0 \\ p & 0 & 0 \\ 0 & p& 0\end{array}\right)\cdot \left(\begin{array}p_1(t-1) \\ p_2(t-1) \\ p_3(t-1)\end{array}\right) $$
