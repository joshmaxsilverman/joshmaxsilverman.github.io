...
$$ \left(\begin{array}{c}P_t(1) \\ P_t(2) \\ P_t(3)\end{array}\right) = \overbrace{\left(\begin{array}{ccc} (1-p) & (1-p) & 0 \\ p & 0 & 0 \\ 0 & p& 0\end{array}\right)}^\mathbf{M} \cdot \left(\begin{array}{c} P_{t-1}(1) \\ P_{t-1}(2) \\ P_{t-1}(3)\end{array}\right) $$
...
Setting $\mathbf{P}_1$ to $\left(1,0,0\right)^\top$ and dotting the result with $\left(0,0,1\right),$ we can extract $P_t(3).$
