...
$$\begin{align}
G(x) &= \frac{x}{1-x} + 2S(1)\left(\int dx\, x^2 + x^3 + x^4\right) + 2S(2)\left(\int dx\, x^3 + x^4 + x^5\right) + \ldots \\
     &= \frac{x}{1-x} + 2S(1)\left(\int dx\, \frac{x^2}{1-x}\right) + 2S(2)\left(\int dx\, \frac{x^3}{1-x}\right) + \ldots \\
     ...
     &= \frac{x}{1-x} + \int dx\, \frac{x}{1-x} 2G(x)
\end{align}$$
