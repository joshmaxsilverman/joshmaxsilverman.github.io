...
$$ 
  \begin{align}
    P_\text{curve}(\text{interior}) &= \int\limits_{1-r}^1 dx_c\hskip{-0.5em}\int\limits_{1-r}^{1-\sqrt{r^2 - (x-1)^2}} dy_c\,\hskip{-0.5em} P_\text{curve}(\text{interior}\lvert x_c,y_c) \\
  \end{align} 
$$
