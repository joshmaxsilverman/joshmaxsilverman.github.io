...
taking cross products, we get $dA = \lvert d\vec{x}_c\times d\vec{x}_r\rvert = \lvert\frac14\left(d\vec{x}_1\times d\vec{x}_2 + d\vec{x}_1\times d\vec{x}_2\right)\rvert = \frac{dx_1dx_2}{2},$ which gives us 
