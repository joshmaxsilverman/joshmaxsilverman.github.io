...
In general, we can have $r$ ranks and $s$ suits. For a general deck, the number of hands playerd is $s\times r/2,$ the probability $\left(1-\frac{3}{2r}\right)$ becomes $\left(1-\frac{s-1}{2}\frac{1}{sr/2}\right)$ Wand we have
