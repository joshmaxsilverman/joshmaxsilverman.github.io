...
Comparison of theoretical (thick lines) and empirical (thin lines, $N=1,000,000$ points per condition) results for $P(\text{no tie})$ for different values of $s$ and $r.$ The black dot indicates the result for a standard deck of cards.
