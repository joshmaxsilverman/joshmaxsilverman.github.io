...
before we embark on calculating, let's sketch out the big picture of $S$ and $J$'s strategies:
...
- at the second level, $S$ is able to learn something about $J$'s first roll, so $S$ should be able to be less aggressive when $J$'s first is low, and more aggressive when $J$'s first roll is high. 
