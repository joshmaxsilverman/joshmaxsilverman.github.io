...
>
>Consider the set $S = \\{(a, b, c, d) | a, b, c, d\in\mathbb{N}, 0 <= a, b, c, d <= 10,000,000\\}.$ Let $M$ be the maximum value $f$ obtains on $S.$ Find $(a, b, c, d)$ in $S$ with minimum sum $(a+b+c+d)$ where $f(a, b, c, d) = M.$
